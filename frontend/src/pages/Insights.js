  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <main className="container-custom py-10 max-w-5xl">
        <Block img="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d" title="💡 Insights Financeiros">
          <p>Analises recentes sobre o mercado e seus impactos no crédito, como a alta da Selic, têm sido destaque em portais como Bloomberg Línea e InfoMoney. Esse cenário influencia diretamente as estratégias de captação de empresas e investidores.</p>
        ...
        <Block img="https://images.unsplash.com/photo-1554224155-6726b3ff858f" title="📊 Fatos Financeiros">
        ...
        <Block img="https://images.unsplash.com/photo-1507679799987-c73779587ccf" title="🔎 Financeiro em Foco">
        ...
        <Block img="https://images.unsplash.com/photo-1507679622673-989605832e3d" title="💰 Mundo das Finanças">
        ...
        <Block img="https://images.unsplash.com/photo-1554224154-22dec7ec8818" title="📌 Notas Financeiras">
