    ...
    <div className="overflow-hidden">
      ...
      <section className="hero-section py-20 relative">
        <div 
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(31, 41, 55, 0.8), rgba(107, 114, 128, 0.8)), url('https://images.unsplash.com/photo-1668911494481-1643ee3e1235?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Njd8MHwxfHNlYXJjaHwyfHxob3VzZSUyMHByb3BlcnR5fGVufDB8fHx8MTc1OTM0OTI2NXww')`,
