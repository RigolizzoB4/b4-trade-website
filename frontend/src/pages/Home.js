  ...
  return (
    ...
    >
      <div className="text-2xl md:text-3xl font-extrabold text-orange-500 tabular-nums group-hover:opacity-0 transition-opacity duration-150">
        <span className="spin-count" style={{animation: 'none'}}>{formatted()}</span>
      </div>
        ...
        <div className="container-custom h-full flex items-center">
          <div className="max-w-3xl">
            ...
            <div className="flex gap-4">
              <a href="https://wa.me/" className="cta-split" target="_blank" rel="noreferrer">
                <span className="cta-left">Saiba</span>
                <span className="cta-box">
                  <span className="cta-line" />
                  <span className="cta-square" />
                  <span className="cta-mais">mais</span>
                </span>
              </a>
            </div>
          </div>
