  ...
  const services = [
    {
      ...
      icon: (
        <div className="w-16 h-16 bg-white border border-orange-400 rounded-2xl flex items-center justify-center shadow-lg hover-lift hover-glow pulse-icon">
      ...
      <section className="hero-section min-h-screen flex items-center relative overflow-hidden hero-parallax">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl">
            {/* Badge */}
            <div className="inline-flex items-center glass-card border border-white/20 rounded-full px-6 py-3 mb-6 hover-lift">
              <span className="w-2 h-2 bg-orange-400 rounded-full mr-2 pulse-icon"></span>
              <span className="text-white/90 text-sm font-semibold">Conheça a B4</span>
            </div>
